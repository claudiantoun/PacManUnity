...
public class Ghost : MonoBehaviour
{
    ...
    public float consumedModeMoveSpeed = 15f;

    public bool canMove = true;

    public float pinkyReleaseTimer = 5;
    public float inkyReleaseTimer = 14;
    public float clydeReleaseTimer = 21;
    ...
    public void SetDifficultyForLevel(int level)
    {
        ...
        else if (level == 5)
        {
            ...
            consumedModeMoveSpeed = 24f;
        }
    }

    public void MoveToStartingPosition()
    {
        if (transform.name != "Red Ghost")
        {
            isInGhostHouse = true;
        }
    ...
    {
        // Select position two tiles in front of PacMan
        ...
        Vector2 tempBlinkyPosition = GameObject.Find("Red Ghost").transform.localPosition;
